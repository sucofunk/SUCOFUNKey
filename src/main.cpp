...
#include "gui/assets/startup-bitmaps.h"
...
void setup() {
  ...
  // ToDo: update bootloadiing process.. sd card needs to be initialized before reading configuration and displaying the status messages
  screenStreaming.setEnabled(true);
  keyboard.setScreenStreaming(&screenStreaming);
#endif
