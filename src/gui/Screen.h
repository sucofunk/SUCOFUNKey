...
Screen(Adafruit_ST7789 *tft, int BL_PIN, int BL_brightness);  
        ...
        const uint16_t C_SELECTION_WARNING = RGBtoColor(250, 50, 10);
        const uint16_t C_SELECTION_COPY = C_ORANGE;
        const uint16_t C_SELECTION_COPY_WARNING = RGBtoColor(250, 50, 10);
        ...
        Area AREA_BOTTOM_MENU = {0, AREA_SCREEN.y2-23, AREA_SCREEN.x2, AREA_SCREEN.y2, false, C_BLACK};   
        ...
        Area AREA_SEQUENCER_OPTIONS_SAMPLENAME = {AREA_SEQUENCER_OPTIONS.x1, AREA_SEQUENCER_OPTIONS.y1, 245, AREA_SEQUENCER_OPTIONS.y1+25, false, C_BLACK};

        Area AREA_SEQUENCER_OPTION1 = {AREA_SEQUENCER_OPTIONS.x1, AREA_SEQUENCER_OPTIONS_SAMPLENAME.y2+2, 80, AREA_SEQUENCER_OPTIONS.y2, false, C_BLACK};
        ...
        Area AREA_SEQUENCER_OPTION3 = {AREA_SEQUENCER_OPTION2.x2, AREA_SEQUENCER_OPTIONS_SAMPLENAME.y2+2, 240, AREA_SEQUENCER_OPTIONS.y2, false, C_BLACK};
        Area AREA_SEQUENCER_OPTION3_BAR = {AREA_SEQUENCER_OPTION2_BAR.x2+1, AREA_SEQUENCER_OPTION1.y1, 240, optionheight, false, C_BLACK};
        
        Area AREA_SEQUENCER_OPTION4 = {AREA_SEQUENCER_OPTION3.x2, AREA_SEQUENCER_OPTIONS_SAMPLENAME.y2+2, AREA_SEQUENCER_OPTIONS.x2, AREA_SEQUENCER_OPTIONS.y2, false, C_BLACK};
        ...
        Area AREA_CONTENT_LINE_1 = { AREA_CONTENT.x1, AREA_CONTENT.y1, AREA_CONTENT.x2, AREA_CONTENT.y1+19, false, C_BLACK};         
        Area AREA_CONTENT_LINE_2 = { AREA_CONTENT.x1, AREA_CONTENT.y1+19, AREA_CONTENT.x2, AREA_CONTENT.y1+38, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_3 = { AREA_CONTENT.x1, AREA_CONTENT.y1+38, AREA_CONTENT.x2, AREA_CONTENT.y1+57, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_4 = { AREA_CONTENT.x1, AREA_CONTENT.y1+57, AREA_CONTENT.x2, AREA_CONTENT.y1+76, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_5 = { AREA_CONTENT.x1, AREA_CONTENT.y1+76, AREA_CONTENT.x2, AREA_CONTENT.y1+95, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_6 = { AREA_CONTENT.x1, AREA_CONTENT.y1+95, AREA_CONTENT.x2, AREA_CONTENT.y1+114, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_7 = { AREA_CONTENT.x1, AREA_CONTENT.y1+114, AREA_CONTENT.x2, AREA_CONTENT.y1+133, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_8 = { AREA_CONTENT.x1, AREA_CONTENT.y1+133, AREA_CONTENT.x2, AREA_CONTENT.y1+152, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_9 = { AREA_CONTENT.x1, AREA_CONTENT.y1+152, AREA_CONTENT.x2, AREA_CONTENT.y1+171, false, C_BLACK}; 
        Area AREA_CONTENT_LINE_10 = { AREA_CONTENT.x1, AREA_CONTENT.y1+171, AREA_CONTENT.x2, AREA_CONTENT.y1+190, false, C_BLACK};

        Area AREA_SETTINGS_VALUES_LINE_1 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1, AREA_CONTENT.x2, AREA_CONTENT.y1+19, false, C_BLACK};
        Area AREA_SETTINGS_VALUES_LINE_2 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+19, AREA_CONTENT.x2, AREA_CONTENT.y1+38, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_3 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+38, AREA_CONTENT.x2, AREA_CONTENT.y1+57, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_4 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+57, AREA_CONTENT.x2, AREA_CONTENT.y1+76, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_5 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+76, AREA_CONTENT.x2, AREA_CONTENT.y1+95, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_6 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+95, AREA_CONTENT.x2, AREA_CONTENT.y1+114, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_7 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+114, AREA_CONTENT.x2, AREA_CONTENT.y1+133, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_8 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+133, AREA_CONTENT.x2, AREA_CONTENT.y1+152, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_9 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+152, AREA_CONTENT.x2, AREA_CONTENT.y1+171, false, C_BLACK}; 
        Area AREA_SETTINGS_VALUES_LINE_10 = { AREA_CONTENT.x2-80, AREA_CONTENT.y1+171, AREA_CONTENT.x2, AREA_CONTENT.y1+190, false, C_BLACK}; 
